...
print('######  Constant time complexity  ####### 1')
print(array[0])


######  Linear time complexity  #######
print('######  Linear time complexity  ####### n')
for element in array:
     print(element)


######  Logarithmic time complexity  #######
print('######  Logarithmic time complexity  #######  Log(n)')
for index in range(0,len(array),3):
     print(array[index])


######  Quadratic time complexity  #######
print('######  Quadratic time complexity  ####### n**2')
for x in array:
    for y in array:
         print(x,y)
...
print('######  Exponential time complexity  ####### 2**n')
def fibonacci(n):
    if n <= 1:
        return n
